...
def process(image):
    ...
    for i, stat in enumerate(stats):
        x, y, w, h, area = stat
        max_area_considered_text = (width * height) * 0.08  # if it covers more than 8 percent of the image, then it is considered the table
        print(max_area_considered_text)
